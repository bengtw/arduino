...
Strip strip_0(11, 6, 11, NEO_RGB + NEO_KHZ800);
...
uint8_t strip0_loop0_eff0() {
    // Strip ID: 0 - Effect: Rainbow - LEDS: 11
    // Steps: 37 - Delay: 96
    // Colors: 3 (255.0.0, 0.255.0, 0.0.255)
    // Options: rainbowlen=54, toLeft=true, 
  if(millis() - strip_0.effStart < 96 * (strip_0.effStep)) return 0x00;
  float factor1, factor2;
  uint16_t ind;
  for(uint16_t j=0;j<11;j++) {
    ind = strip_0.effStep + j * 0.6851851851851852;
  ...
  if(strip_0.effStep >= 37) {strip_0.Reset(); return 0x03; }
